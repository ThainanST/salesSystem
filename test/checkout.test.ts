...
const productData: ProductData = {
    async getProductById(id_product: number): Promise<any> {
            const products: { [id_product: number] : any } = {
                1: { id_product: 1, description: 'A', price: 1000, width: 100, height: 30, length: 10, weight: 3 },
                2: { id_product: 2, description: 'B', price: 5000, width: 50, height: 50, length: 50, weight: 22 },
                3: { id_product: 3, description: 'C', price: 30, width: 10, height: 10, length: 10, weight: 0.9 },
            };
